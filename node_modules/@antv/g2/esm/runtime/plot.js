...
import { AREA_CLASS_NAME, COMPONENT_CLASS_NAME, ELEMENT_CLASS_NAME, LABEL_CLASS_NAME, LABEL_LAYER_CLASS_NAME, MAIN_LAYER_CLASS_NAME, PLOT_CLASS_NAME, VIEW_CLASS_NAME, BREAK_CLASS_NAME, BREAK_GROUP_CLASS_NAME, } from './constant';
...
function plotBreak(view, selection, library, context) {
    ...
    select(breakLayer)
        ...
        .attr('className', BREAK_CLASS_NAME), (update) => update.each(function (d, i, element) {
