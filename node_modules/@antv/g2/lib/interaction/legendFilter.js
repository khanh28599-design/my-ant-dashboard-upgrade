...
exports.LEGEND_FOCUS_ICON_CLASS_NAME = exports.LEGEND_LABEL_CLASS_NAME = exports.LEGEND_MAKER_CLASS_NAME = exports.LEGEND_ITEMS_CLASS_NAME = exports.CONTINUOUS_LEGEND_CLASS_NAME = exports.CATEGORY_LEGEND_CLASS_NAME_HTML = exports.CATEGORY_LEGEND_CLASS_NAME = void 0;
...
exports.CATEGORY_LEGEND_CLASS_NAME_HTML = 'legend-html';
...
function legendsHtmlOf(root) {
    return root.getElementsByClassName(exports.CATEGORY_LEGEND_CLASS_NAME_HTML);
}
...
function LegendFilter() {
    return (context, contexts, emitter) => {
        ...
        const removes = legends.map((legend) => {
            ...
            else if (legend.className === exports.CATEGORY_LEGEND_CLASS_NAME_HTML) {
